<?php
    ...
    $comando = $pdo -> prepare("INSERT INTO produto(nome_produto,preco_produto,quant_estoque, disponivel_venda, foto_produto) VALUES(:nome_produto,:preco_produto,:quant_estoque,:disponivel,:foto)");
