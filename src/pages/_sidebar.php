...
?>
    <div class="col-3 h-100 bg-secondary p-4 pb-2 d-flex flex-column" style="height: 100vh">
        ...
        if ($_SESSION['fk_tipousuario'] == 3) {
            ?>
            <div><input type="button" class="btn btn-outline-light w-100 mt-2 text-start <?php echo ($active == 'vacinas')      ?  'active' : 'menu_option'; ?>" style="border:none" value="Vacinas" onclick="window.location='cadastro_vacina.php'"/></div>
            <?php
        }
        ?>
